<script>
    ...
    function handleWindowClick(e) {
        ...
        if (target.closest(".calendar-fixed-wrapper") || target.closest(".date-btn")) return;
        showCalendarFrom = false;
        showCalendarTo = false;
    }
    ...
    >
        ...
        <div class="popover-header">
            ...
            <div class="header-actions">
                {#if hasActiveFilters}
                    <button class="clear-btn" on:click={clearFilters} transition:fade>
                        <RotateCcw size={11} />
                        Limpar
                    </button>
            ...
            <div class="filter-group">
                ...
                <div class="pill-grid">
                    {#each availableModels as model}
                        ...
                        >
                            <span class="pill-dot" class:active={filters.models.includes(model)}></span>
                            {getModelName(model)}
                        </button>
                    {/each}
                </div>
                ...
                <div class="feature-grid">
                    ...
                    >
                        ...
                        {#if filters.hasImageGen}
                            <div class="check-badge" transition:fade={{duration: 150}}>
                                <Check size={12} />
                            </div>
                        {/if}
                    </button>
                ...
                <div class="date-ranges">
                    <div class="date-field">
                        ...
                        <button
                            ...
                            on:click|stopPropagation={(e) => toggleCalendar("from", e)}
                        >
                            {#if filters.dateFrom}
                    ...
                    <div class="date-field">
                        ...
                        <button
                            ...
                            on:click|stopPropagation={(e) => toggleCalendar("to", e)}
                        >
                            {#if filters.dateTo}
...
<style>
    ...
    .feature-card.active .feature-icon-box.pink { background: rgba(236, 72, 153, 0.2); color: #f472b6; }
    .feature-card.active .feature-icon-box.emerald { background: rgba(16, 185, 129, 0.2); color: #34d399; }
    .feature-card.active .feature-icon-box.blue { background: rgba(59, 130, 246, 0.2); color: #60a5fa; }
